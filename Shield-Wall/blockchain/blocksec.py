...
def start_training():
    ...
    csv_file_path = r'd:/Shield-Wall/blockchain/Malware dataset.csv'  # Replace with your CSV file path
...
background_image = Image.open(r"d:/Shield-Wall/blockchain/WhatsApp Image 2025-01-09 at 17.46.01_567e22d8.jpg") # Replace with the path to your image
